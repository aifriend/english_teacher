...
class EnglishImprovementAgent:
    ...
    def write_properly(self, input_text):  # legacy
        ...
        return self.write_properly_0(input_text)

    def write_properly_0(self, input_text):
        return self.write_service.write_properly_vannity(input_text)

    def write_properly_1(self, input_text):
        # input_text = "This sentences has has bads grammar"
        # input_text = "When I grow up, I start to understand what he said is quite right"
        return self.write_service.write_properly_coedit(input_text)

    def write_properly_2(self, input_text):
        # input_text = "This sentences has has bads grammar"
        # input_text = "When I grow up, I start to understand what he said is quite right"
        return self.write_service.write_properly_instruct(input_text)

    def write_the_same_grammar_fixed(self, input_text):  # legacy
        ...
        return self.write_the_same_grammar_fixed_0(input_text)

    def write_the_same_grammar_fixed_0(self, input_text):
        return self.style_service.write_the_same_grammar_fixed_with_llama_index_rag(input_text)

    def write_the_same_grammar_fixed_1(self, input_text):
